...
message(STATUS "motion_model: 2 messages, 0 services")

set(MSG_I_FLAGS "-Imotion_model:/home/george/rainexam_ws/src/motion_model/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/george/rainexam_ws/src/motion_model/msg/motor.msg" NAME_WE)
add_custom_target(_motion_model_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "motion_model" "/home/george/rainexam_ws/src/motion_model/msg/motor.msg" ""
)

get_filename_component(_filename "/home/george/rainexam_ws/src/motion_model/msg/encoder.msg" NAME_WE)
add_custom_target(_motion_model_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "motion_model" "/home/george/rainexam_ws/src/motion_model/msg/encoder.msg" ""
)
...
_generate_msg_cpp(motion_model
  "/home/george/rainexam_ws/src/motion_model/msg/motor.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motion_model)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/motion_model\")")
  # install generated code
  install(
